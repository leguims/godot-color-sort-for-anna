...
func _build_content_panel() -> void:
	...
	_add_header_ornament($PanneauCredits)
	_add_label($PanneauCredits, Rect2(74, 84, 236, 28), "Crédits et ressources", 18, CORAL, HORIZONTAL_ALIGNMENT_CENTER, false, 1.012)
