...
Carte r'utilisable affichant un titre, une valeur et une couleur de th'me pour les statistiques.
...
- Affiche des indicateurs simples de mani're homog'ne
- Permet de r'p'ter la m'me structure pour plusieurs m'triques
