...
Clavier virtuel utilis' pour cr'er un pseudo depuis le menu principal lorsque le contexte le demande.
...
- Ouvre/ferme un clavier sp'cifique
- Relaye le pseudo saisi ' la sc'ne parente
