...
1.	Score: 1,4	- ~~Ajouter une option pour activer/désactiver la musique~~:heavy_check_mark: V0.3.1
2.	Score: 1,4	- ~~Ajouter une option pour activer/désactiver les vibrations~~:heavy_check_mark: V0.3.1
...
11.	Score: 2,0	- ~~La sélection ne met en surbrillance que les jetons concernés et pas la pile complète~~:heavy_check_mark: V0.3.1
...
15.	Score: 2,1	- Prévoir 2 tableaux de scores : un classement globale et cumulatif de tous les plateaux joués et un classement par ascension. (=> Moins utile si la page de statistiques est réalisée)
